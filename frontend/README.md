...
job classification, eligibility, addresses, work modes, work conditions, compensation,
...
draft: changes to editable classification, primary address, work modes, hours,
deadline, and salary appear there after a successful save.
...
- keep Quick Facts as a read-only summary; scope identity editing and richer
  address selection/review separately from the current text editors;
